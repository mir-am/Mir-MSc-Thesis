...
\begin{LTR}
	\begin{itemize}[label=$\bullet$]
		...
		\item \lr{LightTwinSVM: A simple and fast implementation of standard twin support vector machine classier, The Journal of Open Source Software (Under review).}
	\end{itemize}
\end{LTR}
